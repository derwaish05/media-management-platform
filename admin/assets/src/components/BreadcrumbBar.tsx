 ...
 *   2. Navigates the browser URL to include ?mmp_folder_id=N so WP's
...
/**
 * Updates the `mmp_folder_id` URL query param and navigates (page reload).
...
function navigateToFolder(folderId: number | null): void {
  ...
  if (folderId === null) {
    ...
    url.searchParams.set('mmp_folder_id', String(folderId))
  }
...
const BreadcrumbBar: React.FC = () => {
  ...
  const currentFolder: MmpFolder | undefined =
