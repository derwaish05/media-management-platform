 ...
 *
 * Mounted by main.tsx into #mmp-templates-root.
 *
 * Sections:
...
const FolderTemplatesPage: React.FC = () => {
  ...
  const handleExport = useCallback(async (id: number) => {
    try {
      ...
      a.href     = url
      a.download = `mmp-template-${id}.json`
  ...
  return (
    <div className="mmp-templates-page max-w-5xl mx-auto py-8 px-4 font-sans space-y-10">
      {/* Toast */}
      {toast && (
        <div
          role="status"
