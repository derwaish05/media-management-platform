...
class MediaService {
     ...
     *
     * Fires: do_action('mmp_after_file_assign', $attachmentId, $folderId)
     *
    ...
    public function assignFile(int $attachmentId, int $folderId): bool {
        ...
        if ($success) {
             ...
             * @param int $folderId      Target folder term ID (0 = Uncategorized).
             */
            do_action('mmp_after_file_assign', $attachmentId, $folderId);
        }
     ...
     *
     * Fires: do_action('mmp_after_files_moved', $attachmentIds, $folderId, $movedCount)
     *
    ...
    public function moveFiles(array $attachmentIds, int $folderId): int {
        ...
        if ($moved > 0) {
             ...
             */
            do_action('mmp_after_files_moved', $attachmentIds, $folderId, $moved);
        }
