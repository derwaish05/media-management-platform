 ...
 *
 * Tables used:
 *   wp_mmp_tags              — tag definitions (id, name, slug, color)
...
class TagRepository {
    ...
    public function __construct() {
        global $wpdb;
        $this->db        = $wpdb;
        $this->tagsTable = $wpdb->prefix . 'mmp_tags';
        $this->relTable  = $wpdb->prefix . 'mmp_tag_relationships';
    }
    ...
    public function create( string $name, string $slug, string $color ): int {
        /**
         * Fires before a new MMP tag is created.
         *
         * @param string $name  Tag name.
         * @param string $slug  Tag slug.
         * @param string $color Tag hex colour.
         */
        do_action( 'mmp_before_tag_create', $name, $slug, $color );
        ...
        /**
         * Fires after a new MMP tag has been created.
         *
         ...
         * @param string $color Tag hex colour.
         */
        do_action( 'mmp_after_tag_create', $newId, $name, $slug, $color );
