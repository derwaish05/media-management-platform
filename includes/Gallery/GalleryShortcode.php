...
/**
 * Registers and handles the [mmp_gallery] shortcode.
 *
 * Syntax:
 *   [mmp_gallery folder="42" layout="grid" columns="3" gap="16" lightbox="true" image_size="medium"]
 *
 * Parameters:
...
class GalleryShortcode {
    ...
    public function register(): void {
        add_shortcode( 'mmp_gallery', [ $this, 'renderShortcode' ] );
    }
    ...
    /**
     * Process the [mmp_gallery] shortcode and return HTML.
     *
     ...
     *
     * The CSS handle 'mmp-gallery-block' is registered by GalleryBlock::registerBlock()
    ...
    private function enqueueAssets( bool $lightbox, string $layout = 'grid' ): void {
        ...
        if ( ! wp_style_is( 'mmp-gallery-block', 'registered' ) ) {
            wp_register_style(
                'mmp-gallery-block',
        ...
        wp_enqueue_style( 'mmp-gallery-block' );
