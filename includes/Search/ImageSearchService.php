 ...
 *
 *   - Dominant colour  → mmp_dominant_color (6-char hex, e.g. "3498db")
 *   - Orientation      → mmp_orientation    (landscape | portrait | square)
 *   - ISO              → mmp_exif_iso       (integer string from image_meta)
 *   - Aperture         → mmp_exif_aperture  (float string, e.g. "2.8")
 *   - Focal length     → mmp_exif_focal_len (float string, e.g. "50")
 *
...
class ImageSearchService {
    ...
    public const META_COLOR     = 'mmp_dominant_color';
    public const META_ORIENT    = 'mmp_orientation';
    public const META_ISO       = 'mmp_exif_iso';
    public const META_APERTURE  = 'mmp_exif_aperture';
    public const META_FOCAL_LEN = 'mmp_exif_focal_len';

    private const CRON_HOOK = 'mmp_image_index_upload';
