...
use MMP\Folder\FolderPermission;
use MMP\Folder\FolderRepository;
use MMP\Folder\PermissionRepository;
use WP_REST_Request;
 ...
 *
 * All routes require the `manage_mmp_folders` capability.
 *
 * Routes:
 *   GET    /mmp/v1/folders/{id}/permissions          — list all rules
 *   PUT    /mmp/v1/folders/{id}/permissions          — upsert a rule
 *   DELETE /mmp/v1/folders/{id}/permissions          — delete a rule
 *   POST   /mmp/v1/folders/{id}/permissions/preset   — apply agency preset
 *   GET    /mmp/v1/permissions/presets               — list available presets
 *   GET    /mmp/v1/permissions/check                 — check caller's access
 *
 * @package MMP\API
 * @since   1.0.0
 */
