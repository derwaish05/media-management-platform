...
use MMP\Frontend\DocumentLibrary;
 ...
 *
 * Used by mmp-document-library.js for AJAX subfolder navigation and pagination
...
class DocumentRestController {
     ...
     * published via the [mmp_documents] shortcode — this prevents
