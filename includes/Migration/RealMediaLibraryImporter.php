...
/**
 * Imports folders from the Real Media Library plugin.
 *
 * Real Media Library (free & pro by devowl.io) stores folders as terms in
 * the `media_folder` taxonomy with standard WP term parent relationships.
 * File assignments live in wp_term_relationships.
 *
 * @package MMP\Migration
 * @since   1.0.0
 */
class RealMediaLibraryImporter implements PluginImporterInterface {

    private const SOURCE_TAXONOMY = 'media_folder';
    private const SLUG            = 'rml';
