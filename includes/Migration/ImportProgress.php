 ...
 *
 * Persisted to wp_options under the key `mmp_migration_progress_{slug}` so
...
class ImportProgress {
    ...
    public int    $created   = 0;   // mmp_folder terms created
    ...
    private static function optionKey( string $importerSlug ): string {
        return 'mmp_migration_progress_' . sanitize_key( $importerSlug );
    }
}
