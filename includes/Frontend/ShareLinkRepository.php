 ...
 *
 * Tables managed:
 *   wp_mmp_share_links      — one row per share link
 *   wp_mmp_share_downloads  — one row per file download event
 *
...
class ShareLinkRepository {
    ...
    public function linksTable(): string {
        global $wpdb;
        return $wpdb->prefix . 'mmp_share_links';
    }

    public function downloadsTable(): string {
        global $wpdb;
        return $wpdb->prefix . 'mmp_share_downloads';
    }
