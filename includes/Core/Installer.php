...
final class Installer {
    ...
    public static function install(): void {
        ...
        update_option( 'mmp_db_version', MMP_DB_VERSION, true );
    ...
    /**
     * Returns the full CREATE TABLE SQL for all MMP tables.
    ...
    public static function getSchemaSql( string $prefix, string $charset ): string {
        ...
        // ------------------------------------------------------------------
        $tables[] = "CREATE TABLE {$prefix}mmp_user_prefs (
  ...
  UNIQUE KEY user_id (user_id)
        ...
        // ------------------------------------------------------------------
        $tables[] = "CREATE TABLE {$prefix}mmp_versions (
  id bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  KEY created_at (created_at)
        ...
        // ------------------------------------------------------------------
        $tables[] = "CREATE TABLE {$prefix}mmp_usage (
  id bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  attachment_id bigint(20) UNSIGNED NOT NULL,
  ...
  KEY object_id (object_id)
        ...
        // ------------------------------------------------------------------
        $tables[] = "CREATE TABLE {$prefix}mmp_permissions (
  id bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  KEY folder_id (folder_id)
        ...
        // ------------------------------------------------------------------
        $tables[] = "CREATE TABLE {$prefix}mmp_analytics (
  id bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  attachment_id bigint(20) UNSIGNED NOT NULL,
  ...
  KEY event_type (event_type)
        ...
        // Smart tags.
        // ------------------------------------------------------------------
        $tables[] = "CREATE TABLE {$prefix}mmp_tags (
  id bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY slug (slug)
        ...
        // ------------------------------------------------------------------
        $tables[] = "CREATE TABLE {$prefix}mmp_tag_relationships (
  ...
  KEY attachment_id (attachment_id)
    ...
    private static function setDefaultOptions(): void {
        ...
        add_option( 'mmp_settings', $defaults, '', false );
    }
    ...
    private static function addCapabilities(): void {
        ...
        if ( $admin ) {
            $admin->add_cap( 'manage_mmp_folders' );
            $admin->add_cap( 'manage_mmp_settings' );
        }

        $editor = get_role( 'editor' );

        if ( $editor ) {
            $editor->add_cap( 'manage_mmp_folders' );
        }
    }
}
