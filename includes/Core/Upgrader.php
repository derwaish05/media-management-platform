...
final class Upgrader {
     ...
     * Compares the stored DB version against MMP_DB_VERSION and runs
     * any pending migrations.
     */
    public static function maybeUpgrade(): void {
        $stored = get_option( 'mmp_db_version', '0.0.0' );

        if ( version_compare( $stored, MMP_DB_VERSION, '>=' ) ) {
            return;
        }
    ...
    /**
     * v1.1.0 — ensure mmp_tags + mmp_tag_relationships tables exist for sites
